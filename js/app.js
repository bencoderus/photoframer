    ...
    croppie.result({
        ...
        $.ajax({
            ...
            success: (response) => {
                ...
                let data = `<a class="btn btn-danger rounded-0" href="${response}" download>Download</a>`
                ...
                if (myXhr.upload) {
                    myXhr.upload.addEventListener('progress', function (e) {
                        if (e.lengthComputable) {
                            ...
                            document.getElementById("download").innerHTML = "Image generated!";
                        }
                    }, false);
                }
                return myXhr;
...
let onFileChange = (input) => {
    ...
    $("#imagedownload").html("")
    $("#download").text("Generate image").show()
}
